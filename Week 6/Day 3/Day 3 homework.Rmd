...
_The point estimate for my infered data is 10149, compared to 10148 for the original data_
```{r}
infer_150 %>% 
...
_More replicates is bring the value closer to the observed mean_
```{r}
ames %>% 
