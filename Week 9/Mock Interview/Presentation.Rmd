...
There is a similar pattern in some other regions of Scotland, in particular Glasgow as shown below but not all regions.
...
Breast cancer screening begins at age 50 (or the next time screening at local GP is available). There is a large jump in incidences of Breast cancer in Females moving into age 45 to 49 age range. Should possibly consider lowering the age of screening to 45. Increase in rate for 50-54 group could partially be explained by the increased screening and therefore detection.
